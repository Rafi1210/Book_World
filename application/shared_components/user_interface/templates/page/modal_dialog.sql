...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(103333292930980026574)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333293278934026574)
,p_page_template_id=>wwv_flow_imp.id(103333292930980026574)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333293598896026574)
,p_page_template_id=>wwv_flow_imp.id(103333292930980026574)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333293811619026574)
,p_page_template_id=>wwv_flow_imp.id(103333292930980026574)
