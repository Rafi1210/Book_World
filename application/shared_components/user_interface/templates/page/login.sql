...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(103333282857441026569)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333283146273026569)
,p_page_template_id=>wwv_flow_imp.id(103333282857441026569)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333283401403026569)
,p_page_template_id=>wwv_flow_imp.id(103333282857441026569)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333283792816026570)
,p_page_template_id=>wwv_flow_imp.id(103333282857441026569)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333284038053026570)
,p_page_template_id=>wwv_flow_imp.id(103333282857441026569)
,p_name=>'Body Footer'
