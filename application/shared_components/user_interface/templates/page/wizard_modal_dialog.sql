...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(103333301568117026579)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333301854484026580)
,p_page_template_id=>wwv_flow_imp.id(103333301568117026579)
,p_name=>'Wizard Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333302182048026580)
,p_page_template_id=>wwv_flow_imp.id(103333301568117026579)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333302490986026580)
,p_page_template_id=>wwv_flow_imp.id(103333301568117026579)
