...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333341693462026599)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333341968886026599)
,p_plug_template_id=>wwv_flow_imp.id(103333341693462026599)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333342245048026599)
,p_plug_template_id=>wwv_flow_imp.id(103333341693462026599)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333342551373026599)
,p_plug_template_id=>wwv_flow_imp.id(103333341693462026599)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333342892074026599)
,p_plug_template_id=>wwv_flow_imp.id(103333341693462026599)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333343169201026600)
,p_plug_template_id=>wwv_flow_imp.id(103333341693462026599)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
