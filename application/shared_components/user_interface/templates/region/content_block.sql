...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333337080360026597)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333337344235026597)
,p_plug_template_id=>wwv_flow_imp.id(103333337080360026597)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333337699904026597)
,p_plug_template_id=>wwv_flow_imp.id(103333337080360026597)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333337993476026597)
,p_plug_template_id=>wwv_flow_imp.id(103333337080360026597)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333338256590026597)
,p_plug_template_id=>wwv_flow_imp.id(103333337080360026597)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333338580942026597)
,p_plug_template_id=>wwv_flow_imp.id(103333337080360026597)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333338859570026597)
,p_plug_template_id=>wwv_flow_imp.id(103333337080360026597)
,p_name=>'Sub Regions'
