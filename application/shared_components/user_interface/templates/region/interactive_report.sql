...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333365133491026609)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333365414116026609)
,p_plug_template_id=>wwv_flow_imp.id(103333365133491026609)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333365788618026609)
,p_plug_template_id=>wwv_flow_imp.id(103333365133491026609)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333366033745026610)
,p_plug_template_id=>wwv_flow_imp.id(103333365133491026609)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333366379297026610)
,p_plug_template_id=>wwv_flow_imp.id(103333365133491026609)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333366689649026610)
,p_plug_template_id=>wwv_flow_imp.id(103333365133491026609)
,p_name=>'Sub Regions'
