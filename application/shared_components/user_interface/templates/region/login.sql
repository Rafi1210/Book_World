...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333369793910026611)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333370059742026612)
,p_plug_template_id=>wwv_flow_imp.id(103333369793910026611)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333370306848026612)
,p_plug_template_id=>wwv_flow_imp.id(103333369793910026611)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333370632880026612)
,p_plug_template_id=>wwv_flow_imp.id(103333369793910026611)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333370940958026612)
,p_plug_template_id=>wwv_flow_imp.id(103333369793910026611)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333371299718026612)
,p_plug_template_id=>wwv_flow_imp.id(103333369793910026611)
,p_name=>'Sub Regions'
