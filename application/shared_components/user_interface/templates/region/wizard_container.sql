...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333392443494026622)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333392796719026622)
,p_plug_template_id=>wwv_flow_imp.id(103333392443494026622)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333393033463026622)
,p_plug_template_id=>wwv_flow_imp.id(103333392443494026622)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333393323809026622)
,p_plug_template_id=>wwv_flow_imp.id(103333392443494026622)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333393676667026623)
,p_plug_template_id=>wwv_flow_imp.id(103333392443494026622)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333393967355026623)
,p_plug_template_id=>wwv_flow_imp.id(103333392443494026622)
