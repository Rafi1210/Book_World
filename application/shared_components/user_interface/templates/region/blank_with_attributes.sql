...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333308205665026583)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333308560971026583)
,p_plug_template_id=>wwv_flow_imp.id(103333308205665026583)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333308803324026583)
,p_plug_template_id=>wwv_flow_imp.id(103333308205665026583)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333309103629026583)
,p_plug_template_id=>wwv_flow_imp.id(103333308205665026583)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333309496001026584)
,p_plug_template_id=>wwv_flow_imp.id(103333308205665026583)
,p_name=>'Sub Regions'
