...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333355133422026605)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333355477493026605)
,p_plug_template_id=>wwv_flow_imp.id(103333355133422026605)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333355701175026605)
,p_plug_template_id=>wwv_flow_imp.id(103333355133422026605)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333356059142026605)
,p_plug_template_id=>wwv_flow_imp.id(103333355133422026605)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333356382735026605)
,p_plug_template_id=>wwv_flow_imp.id(103333355133422026605)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333356674603026606)
,p_plug_template_id=>wwv_flow_imp.id(103333355133422026605)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333356991735026606)
,p_plug_template_id=>wwv_flow_imp.id(103333355133422026605)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333357259931026606)
,p_plug_template_id=>wwv_flow_imp.id(103333355133422026605)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333357554492026606)
,p_plug_template_id=>wwv_flow_imp.id(103333355133422026605)
,p_name=>'Sub Regions'
