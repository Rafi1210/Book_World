...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333384721550026619)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333385093817026619)
,p_plug_template_id=>wwv_flow_imp.id(103333384721550026619)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333385335910026619)
,p_plug_template_id=>wwv_flow_imp.id(103333384721550026619)
,p_name=>'Tabs'
