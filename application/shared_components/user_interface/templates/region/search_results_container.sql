...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333372264951026613)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333372512094026613)
,p_plug_template_id=>wwv_flow_imp.id(103333372264951026613)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333372845093026613)
,p_plug_template_id=>wwv_flow_imp.id(103333372264951026613)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333373119869026613)
,p_plug_template_id=>wwv_flow_imp.id(103333372264951026613)
,p_name=>'Sub Regions'
