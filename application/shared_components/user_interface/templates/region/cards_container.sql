...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333315345454026587)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333315695892026587)
,p_plug_template_id=>wwv_flow_imp.id(103333315345454026587)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333315945247026587)
,p_plug_template_id=>wwv_flow_imp.id(103333315345454026587)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333316281709026587)
,p_plug_template_id=>wwv_flow_imp.id(103333315345454026587)
,p_name=>'Sub Regions'
