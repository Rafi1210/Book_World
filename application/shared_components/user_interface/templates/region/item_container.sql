...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333367234280026610)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333367564257026610)
,p_plug_template_id=>wwv_flow_imp.id(103333367234280026610)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333367844233026611)
,p_plug_template_id=>wwv_flow_imp.id(103333367234280026610)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333368178851026611)
,p_plug_template_id=>wwv_flow_imp.id(103333367234280026610)
,p_name=>'Button Start'
