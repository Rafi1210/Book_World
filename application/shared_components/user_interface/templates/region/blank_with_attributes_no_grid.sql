...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333309692086026584)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333309901833026584)
,p_plug_template_id=>wwv_flow_imp.id(103333309692086026584)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333310241712026584)
,p_plug_template_id=>wwv_flow_imp.id(103333309692086026584)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333310531045026584)
,p_plug_template_id=>wwv_flow_imp.id(103333309692086026584)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333310865481026585)
,p_plug_template_id=>wwv_flow_imp.id(103333309692086026584)
,p_name=>'Sub Regions'
