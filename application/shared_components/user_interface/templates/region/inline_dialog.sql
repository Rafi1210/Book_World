...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333350570194026603)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333350823051026603)
,p_plug_template_id=>wwv_flow_imp.id(103333350570194026603)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333351100017026603)
,p_plug_template_id=>wwv_flow_imp.id(103333350570194026603)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333351443411026603)
,p_plug_template_id=>wwv_flow_imp.id(103333350570194026603)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333351724090026603)
,p_plug_template_id=>wwv_flow_imp.id(103333350570194026603)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333352017498026604)
,p_plug_template_id=>wwv_flow_imp.id(103333350570194026603)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333352374656026604)
,p_plug_template_id=>wwv_flow_imp.id(103333350570194026603)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333352604791026604)
,p_plug_template_id=>wwv_flow_imp.id(103333350570194026603)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333352987407026604)
,p_plug_template_id=>wwv_flow_imp.id(103333350570194026603)
,p_name=>'Sub Regions'
