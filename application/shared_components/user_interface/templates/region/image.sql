...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(103333345126179026600)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333345436081026601)
,p_plug_template_id=>wwv_flow_imp.id(103333345126179026600)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(103333345723628026601)
,p_plug_template_id=>wwv_flow_imp.id(103333345126179026600)
,p_name=>'Sub Regions'
