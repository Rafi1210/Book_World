...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(103333454855958026653)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(103333455115685026655)
,p_plugin_id=>wwv_flow_imp.id(103333454855958026653)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333455493454026655)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333455115685026655)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333455800098026656)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333455115685026655)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333456258188026656)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333455115685026655)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(103333456616904026657)
,p_plugin_id=>wwv_flow_imp.id(103333454855958026653)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(103333455115685026655)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(103333456956611026657)
,p_plugin_id=>wwv_flow_imp.id(103333454855958026653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(103333457241533026657)
,p_plugin_id=>wwv_flow_imp.id(103333454855958026653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(103333457520014026657)
,p_plugin_id=>wwv_flow_imp.id(103333454855958026653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(103333457819978026658)
,p_plugin_id=>wwv_flow_imp.id(103333454855958026653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333458186802026658)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333457819978026658)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333458528039026658)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333457819978026658)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333458965032026659)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333457819978026658)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333459343583026659)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333457819978026658)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(103333459726216026659)
,p_plugin_id=>wwv_flow_imp.id(103333454855958026653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333460031163026660)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333459726216026659)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333460425325026660)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333459726216026659)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333460819064026660)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333459726216026659)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333461226406026660)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333459726216026659)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333461640919026661)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333459726216026659)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333462065881026661)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333459726216026659)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(103333462430907026662)
,p_plugin_attribute_id=>wwv_flow_imp.id(103333459726216026659)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(103333462858943026662)
,p_plugin_id=>wwv_flow_imp.id(103333454855958026653)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(105133505734191140406)
,p_plugin_id=>wwv_flow_imp.id(103333454855958026653)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
