...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103334215944845030364)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103334216009332030364)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103334216180815030364)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103334215944845030364)
,p_button_name=>'NEXT'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103334218166909030365)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_imp.id(103334215944845030364)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(103334219522833030366)
,p_branch_action=>'f?p=&APP_ID.:10044:&APP_SESSION.::&DEBUG.:RP,10044::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_when_button_id=>wwv_flow_imp.id(103334216180815030364)
,p_branch_sequence=>10
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103334219921057030366)
,p_name=>'P10043_ROLE'
,p_is_required=>true
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(103334216009332030364)
,p_prompt=>'Roles'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103334220372157030367)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103334220707589030367)
...
,p_lov=>'.'||wwv_flow_imp.id(103334220851136030367)||'.'
,p_field_template=>wwv_flow_imp.id(103333446999743026650)
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_attribute_01=>'1'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103334218253672030365)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(103334218166909030365)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103334219005970030366)
,p_event_id=>wwv_flow_imp.id(103334218253672030365)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(103334222067884030368)
...
,p_process_when_button_id=>wwv_flow_imp.id(103334216180815030364)
,p_internal_uid=>103334222067884030368
);
