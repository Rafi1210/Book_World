...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103334317377019030973)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(103334317677483030973)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(103334316947312030973)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(103334318133795030974)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(103334317677483030973)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(103334318401063030974)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103334318973388030974)
,p_event_id=>wwv_flow_imp.id(103334318401063030974)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(103334319460552030975)
,p_event_id=>wwv_flow_imp.id(103334318401063030974)
